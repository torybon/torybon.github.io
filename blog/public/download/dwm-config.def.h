...
static const char col_nordbgSel[]   = "#4682B4";
static const char col_nordborderSel[] = "#F0F8FF";
...
/* static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_nordfg, "-nf", col_nordborder, "-sb", col_nordborderSel, "-sf", col_nordfgSel, NULL }; */
